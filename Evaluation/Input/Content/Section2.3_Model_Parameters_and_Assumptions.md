...
Values for lipophilicity and fraction unbound in plasma were fixed to literature values (namely to 2.3 ([Lappin 2011](#5 References)) and 0.30 ([Chu 1993a](#5 References)) for lipophilicity and fraction unbound, respectively). 
...
| K<sub>I</sub>                      | 6.04            | µmol/L |
| k<sub>inact</sub>                  | 0.04            | 1/min  |
